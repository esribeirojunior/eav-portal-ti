        ...
        <div className="flex-1 overflow-y-auto bg-slate-100 dark:bg-[#0c0d21] p-6 md:p-12 relative transition-colors duration-300">
            <div className="max-w-5xl mx-auto">
                <div className="mb-10">
                    ...
                    <p className="text-slate-800 dark:text-slate-500 mt-2 text-lg">Gerencie acessos e os cadastros base do sistema.</p>
                </div>

                <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-400 dark:border-white/5 shadow-sm overflow-hidden">
                    <div className="flex border-b border-slate-400 dark:border-white/5">
                        <button 
                            onClick={() => setActiveTab('users')}
                            className={`flex-1 flex items-center justify-center gap-2 py-5 text-sm font-bold transition-all ${activeTab === 'users' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400 bg-indigo-50/50 dark:bg-indigo-500/5' : 'text-slate-800 dark:text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5'}`}
                        >
                            <Users size={18} /> Equipe de TI
                        </button>
                        <button 
                            onClick={() => setActiveTab('departments')}
                            className={`flex-1 flex items-center justify-center gap-2 py-5 text-sm font-bold transition-all ${activeTab === 'departments' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400 bg-indigo-50/50 dark:bg-indigo-500/5' : 'text-slate-800 dark:text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5'}`}
                        >
                            <Building2 size={18} /> Setores
                        </button>
                        <button 
                            onClick={() => setActiveTab('employees')}
                            className={`flex-1 flex items-center justify-center gap-2 py-5 text-sm font-bold transition-all ${activeTab === 'employees' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400 bg-indigo-50/50 dark:bg-indigo-500/5' : 'text-slate-800 dark:text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5'}`}
                        >
                    ...
                    <div className="p-8">
                        {activeTab === 'users' && (
                            <div className="space-y-8">
                                <div className="bg-slate-50 dark:bg-[#15162c] p-6 rounded-2xl border border-slate-400 dark:border-white/5">
                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Adicionar Administrador</h3>
                                    <form onSubmit={handleAddUser} className="flex gap-4">
                                        <input 
                                            type="email" 
                                            placeholder="E-mail corporativo" 
                                            className="flex-1 bg-white dark:bg-[#0c0d21] border border-slate-400 dark:border-white/10 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder:text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            value={newUserEmail}
                                        ...
                                        <input 
                                            ...
                                            className="w-64 bg-white dark:bg-[#0c0d21] border border-slate-400 dark:border-white/10 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder:text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                ...
                                <div className="border border-slate-400 dark:border-white/5 rounded-2xl overflow-hidden">
                                    <table className="w-full text-left text-sm">
                                        <thead className="bg-slate-50 dark:bg-[#15162c] text-slate-800 dark:text-slate-500 font-bold uppercase tracking-wider text-xs">
                                            <tr>
                                        ...
                                        <tbody className="divide-y divide-slate-200 dark:divide-white/5">
                                                ...
                                                <tr key={u.id} className="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <select 
                                                            ...
                                                            className="bg-slate-100 dark:bg-white/5 border border-slate-400 dark:border-white/10 text-slate-700 dark:text-slate-300 text-xs rounded-lg px-2 py-1.5 font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                                        >
                                                    ...
                                                    <td className="px-6 py-4 text-center">
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-slate-800 dark:text-slate-300 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 rounded-lg transition-colors"
                                                        >
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <button 
                                                            ...
                                                            className="p-2 text-slate-700 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors"
                                            ...
                                            {users.length === 0 && (
                                                <tr>
                                                    <td colSpan={3} className="px-6 py-8 text-center text-slate-800">Nenhum usuário encontrado.</td>
                                                </tr>
                                            )}
                                        </tbody>
                                    </table>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="border border-slate-400 dark:border-white/5 rounded-2xl overflow-hidden grid grid-cols-2 gap-4 p-4">
                                    ...
                                    {departments.length === 0 && (
                                        <div className="col-span-2 text-center py-8 text-slate-800">Nenhum setor cadastrado.</div>
                                    )}
                                </div>
                            </div>
                        )}
