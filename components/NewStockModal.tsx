      ...
      <div className="bg-slate-900 w-full max-w-2xl max-h-[90vh] rounded-3xl border border-white/10 shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black text-white uppercase tracking-widest">Cadastrar Estoque Novo</h2>
        ...
        {result ? (
          <div className="p-8 flex flex-col items-center gap-4 text-center">
            ...
            <h3 className="text-2xl font-black text-white">{result.count} dispositivos cadastrados</h3>
            <p className="text-white/60 text-sm">
              Tags geradas de <span className="font-black text-amber-400">{result.firstTag}</span>
              {' '}até <span className="font-black text-amber-400">{result.lastTag}</span>
            </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white text-lg font-black focus:outline-none focus:border-amber-500/50"
                  required
                />
              </div>
              <div className="col-span-2">
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm font-bold focus:outline-none focus:border-amber-500/50"
                >
                  {DEVICE_TYPES.map((t) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-amber-500/50 resize-none"
