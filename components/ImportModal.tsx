    ...
    const handleImport = async () => {
        ...
        try {
            ...
            for (const row of previewData) {
                ...
                else if (lowerType.includes('mini pc') || lowerType.includes('mini-pc') || lowerType.includes('minipc')) type = DeviceType.MINI_PC;
                else if (lowerType.includes('tv') || lowerType.includes('televisão') || lowerType.includes('televisao')) type = DeviceType.TV;
