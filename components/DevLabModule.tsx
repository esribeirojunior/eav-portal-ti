...
const DevLabModule = ({ onBack, userEmail, onSelectModule }: DevLabModuleProps) => {
    ...
    return (
        <div className="min-h-screen bg-[#f4f7fc] dark:bg-[#0c0d21] p-6 sm:p-12 animate-in fade-in duration-500 pb-24 text-left font-sans transition-colors">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="p-4 bg-white dark:bg-white/5 rounded-2xl hover:bg-slate-50 dark:hover:bg-white/10 transition-all text-slate-500 dark:text-white/40 border border-slate-200 dark:border-white/5 active:scale-90 shadow-sm dark:shadow-none"
                        >
                            <ChevronLeft size={24} />
                        </button>
                        <div>
                    ...
                    {activeProject && (
                        <div className="hidden md:flex items-center gap-8 px-8 py-4 bg-white dark:bg-white/5 rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none">
                            <div className="text-center">
                                <p className="text-[9px] font-black text-slate-400 dark:text-white/20 uppercase tracking-widest">Total</p>
                ...
                {!activeProject ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <button 
                            ...
                            className="group bg-white dark:bg-slate-900/60 p-10 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-sm hover:shadow-md dark:shadow-none hover:border-cyan-500/30 transition-all hover:translate-y-[-8px] text-left relative overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-slate-500 dark:text-white/40 text-sm font-medium leading-relaxed italic">
                        ...
                        <button 
                            ...
                            className="group bg-white dark:bg-slate-900/60 p-10 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-sm hover:shadow-md dark:shadow-none hover:border-blue-500/30 transition-all hover:translate-y-[-8px] text-left relative overflow-hidden"
                        >
                        ...
                        <button 
                            ...
                            className="group bg-white dark:bg-slate-900/60 p-10 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-sm hover:shadow-md dark:shadow-none hover:border-orange-500/30 transition-all hover:translate-y-[-8px] text-left relative overflow-hidden"
                        >
                    ...
                    <div className="animate-in zoom-in-95 duration-500 space-y-8">
                        <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none rounded-[3rem] p-8 md:p-12">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-slate-500 dark:text-white/40 text-sm font-medium italic">Campus Escola Americana de Vitória</p>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                    <div className="relative group flex-1">
                                        <input
                                            ...
                                            className="w-full md:w-64 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl py-5 px-12 text-[10px] font-black text-slate-900 dark:text-white outline-none focus:border-cyan-500 transition-all placeholder:text-slate-400 dark:placeholder:text-white/10 tracking-widest"
                                            value={searchQuery}
                                            onChange={(e) => setSearchQuery(e.target.value)}
                                        />
                                        <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-white/20 group-focus-within:text-cyan-500 transition-colors" size={16} />
                                    </div>
                            ...
                            {/* Tabs de Filtro */}
                            <div className="flex gap-4 mb-8 border-b border-slate-200 dark:border-white/5 pb-4 overflow-x-auto no-scrollbar">
                                <button
                                    ...
                                    return (
                                        <div key={i} className={`p-5 rounded-[1.5rem] border transition-all hover:scale-[1.03] flex flex-col gap-3 relative overflow-hidden group ${style.bg} ${style.border}`}>
                                            ...
                                            <div className="relative z-10 space-y-1">
                                                <div className="text-[9px] font-black text-slate-500 dark:text-white/30 uppercase tracking-[0.2em]">
                                                    Ramal {r.ramal}
                                                </div>
                            ...
                            <div className="mt-12 p-8 bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8">
                                <div className="flex items-start gap-6">
                                    <div className="p-4 bg-white dark:bg-white/5 rounded-2xl text-cyan-600 dark:text-cyan-500 shadow-sm dark:shadow-none border border-slate-200 dark:border-none">
                                        <ShieldCheck size={24} />
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[11px] font-black text-slate-500 dark:text-white/40 uppercase tracking-widest">Modo de Operação:</p>
                                        <p className="text-xs text-slate-400 dark:text-white/20 font-medium leading-relaxed italic max-w-xl">
            ...
            {/* Footer */}
            <div className="text-center pt-10 border-t border-slate-200 dark:border-white/5 no-print mt-10">
