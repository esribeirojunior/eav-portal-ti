    ...
    const getStatusStyles = (estado: string) => {
        ...
        if (lower.includes('ocupado') || lower.includes('busy') || lower.includes('falando')) {
            return {
                ...
                text: 'text-rose-400',
                dot: 'bg-rose-500',
                icon: <PhoneCall size={18} className="text-rose-500" />
            };
        }
        return {
            bg: 'bg-amber-500/10',
            ...
            text: 'text-amber-400',
            dot: 'bg-amber-500',
            icon: <PhoneOff size={18} className="text-amber-400" />
        };
    };
            ...
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h2 className="text-4xl font-[1000] uppercase tracking-tighter text-white">TI Beta Lab</h2>
                            <p className="text-cyan-400/60 text-[10px] font-black tracking-[0.3em] uppercase mt-1">Monitoramento Estrutural EAV</p>
                        </div>
                    </div>

                    {activeProject && (
                        <div className="hidden md:flex items-center gap-8 px-8 py-4 bg-white/5 rounded-[2rem] border border-white/5">
                            <div className="text-center">
                                <p className="text-[9px] font-black text-white/20 uppercase tracking-widest">Total</p>
                                <p className="text-xl font-black text-white">{ramais.length}</p>
                            </div>
                            <div className="text-center">
                                <p className="text-[9px] font-black text-emerald-500/40 uppercase tracking-widest">Livres</p>
                                <p className="text-xl font-black text-emerald-500">{ramais.filter(r => r.estado.toLowerCase().includes('livre')).length}</p>
                            </div>
                            <div className="text-center">
                                <p className="text-[9px] font-black text-rose-500/40 uppercase tracking-widest">Ocupados</p>
                                <p className="text-xl font-black text-rose-500">{ramais.filter(r => !r.estado.toLowerCase().includes('livre')).length}</p>
                            </div>
                        </div>
                    )}
                </div>
                ...
                {!activeProject ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter group-hover:text-cyan-400 transition-colors">Monitor de Campus</h3>
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter group-hover:text-cyan-400 transition-colors">Gestão de Tarefas TI</h3>
                                    <p className="text-white/40 text-sm font-medium leading-relaxed italic">
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter group-hover:text-blue-400 transition-colors">Cofre de Senhas</h3>
                                    <p className="text-white/40 text-sm font-medium leading-relaxed italic">
                                        Acesso seguro a chaves de API e credenciais Bitwarden.
                                    </p>
                                </div>
                                <div className="pt-4 flex items-center gap-3 text-blue-400 text-[10px] font-black uppercase tracking-widest group-hover:gap-5 transition-all">
                                    <span>Acessar</span>
                                    <Activity size={14} />
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter group-hover:text-orange-400 transition-colors">Passo a Passo TI</h3>
                                    <p className="text-white/40 text-sm font-medium leading-relaxed italic">
                                        Procedimentos de suporte ao usuário e manuais técnicos.
                                    </p>
                                </div>
                                <div className="pt-4 flex items-center gap-3 text-orange-400 text-[10px] font-black uppercase tracking-widest group-hover:gap-5 transition-all">
                                    <span>Acessar</span>
                                    <Activity size={14} />
                                </div>
                            </div>
                    ...
                    <div className="animate-in zoom-in-95 duration-500 space-y-8">
                        <div className="bg-[#14152e]/60 border border-white/5 rounded-[3rem] p-8 md:p-12">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-3 text-cyan-500">
                                        <Phone size={24} />
                                        <h3 className="text-3xl font-[1000] text-white uppercase tracking-tight">Status da Telefonia</h3>
                                    </div>
                                    <p className="text-white/40 text-sm font-medium italic">Campus Escola Americana de Vitória</p>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                    <div className="relative group flex-1">
                                        <input
                                            ...
                                            className="w-full md:w-64 bg-white/5 border border-white/10 rounded-2xl py-5 px-12 text-[10px] font-black text-white outline-none focus:border-cyan-500 transition-all placeholder:text-white/10 tracking-widest"
                                            value={searchQuery}
                                            onChange={(e) => setSearchQuery(e.target.value)}
                                        />
                                        <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-cyan-500 transition-colors" size={16} />
                                    </div>
                                    ...
                                    return (
                                        <div key={i} className={`p-5 rounded-[1.5rem] border transition-all hover:scale-[1.03] flex flex-col gap-3 relative overflow-hidden group ${style.bg} ${style.border}`}>
                                            ...
                                            <div className="relative z-10 space-y-1">
                                                ...
                                                <h4 className="text-sm font-black text-white uppercase tracking-tight leading-tight break-words group-hover:text-cyan-400 transition-colors">
                                                    {r.nome}
                                                </h4>
                                            </div>
                                        </div>
                            ...
                            <div className="mt-12 p-8 bg-black/40 border border-white/5 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8">
                                <div className="flex items-start gap-6">
                                    <div className="p-4 bg-white/5 rounded-2xl text-cyan-500">
                                        <ShieldCheck size={24} />
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[11px] font-black text-white/40 uppercase tracking-widest">Modo de Operação:</p>
                                        <p className="text-xs text-white/20 font-medium leading-relaxed italic max-w-xl">
                                ...
                                <div className="flex items-center gap-3 text-[10px] font-black text-cyan-500/40 uppercase tracking-widest">
